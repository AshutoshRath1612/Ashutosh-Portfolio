...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["front end development", "designing" , "back end development"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
function sendMail() {
    ...
    let value  = `Name:${myName}\nEmail:${myEmail}\nPhone:${myPhone}\nMessage:${myText}`
    var link = "mailto:ashutoshrath1612@gmail.com"
             + "?subject=" + encodeURIComponent(`Hey I am ${myName} trying to reach out to you.`)
